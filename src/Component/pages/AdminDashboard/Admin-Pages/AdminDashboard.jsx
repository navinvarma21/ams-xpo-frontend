...
import Add_Announcements from "./Announcements/Add_Announcements";
import View_Announcements from "./Announcements/View_Announcements";
import Add_Events from "./Events/Add_Events";
import View_Events from "./Events/View_Events";
import Add_Exams from "./Examination-Management/Add_Exams";
import View_Exam_Details from "./Examination-Management/View_Exam_Details";
import Add_Subject_Details from "./Student-Management/Add_Subject_Details";
import Attendance from "./Student-Management/Attendane";
import Exam_Records from "./Student-Management/Exam_Records";
import Subject_and_Grades_1to9 from "./Student-Management/Subject_and_Grades_1to9";
import Subject_and_Grades_10to12 from "./Student-Management/Subject_and_Grades_10to12";
import View_Attendance from "./Student-Management/View_Attendance";
import Add_New_Teacher from "./Teacher-Management/Add_New_Teacher";
import Search_Teacher from "./Teacher-Management/Search_Teacher";
import Subject_to_Handle from "./Teacher-Management/Subject_to_Handle";
import Timetable from "./Teacher-Management/Timetable";
import View_Timetable from "./Teacher-Management/View_Timetable";
