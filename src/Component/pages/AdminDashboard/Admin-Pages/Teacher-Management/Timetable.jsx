...
const Timetable = () => {
  ...
  return (
    ...
    <select name="standard" required className="timetable__input-dropdown">
        ...
        <select name="section" required className="timetable__input-dropdown">
          <option value="" disabled selected>
            Section
          </option>
          ...
          <div className="timetable-form">
            {currentStep === 1 && (
              <div className="period">
                <h2 style={{ color: "white" }}>Period 1</h2>
            ...
            {currentStep === 2 && (
              <div className="period">
                <h2 style={{ color: "white" }}>Period 2</h2>
            ...
            {currentStep === 3 && (
              <div className="period">
                <h2 style={{ color: "white" }}>Period 3</h2>
            ...
            {currentStep === 4 && (
              <div className="period">
                <h2 style={{ color: "white" }}>Period 4</h2>
            ...
            {currentStep === 5 && (
              <div className="period">
                <h2 style={{ color: "white" }}>Period 5</h2>
            ...
            {currentStep === 6 && (
              <div className="period">
                <h2 style={{ color: "white" }}>Period 6</h2>
            ...
            {currentStep === 7 && (
              <div className="period">
                <h2 style={{ color: "white" }}>Period 7</h2>
